...
registerTool(
  ...
  'yuance_handoff_work_item',
  {
    title: '流转工作项',
    description:
      '按工作项状态机流转 / 指派工作项，并记录流转说明。需要 work_item:read 和 work_item:write scope。',
    inputSchema: {
      item_key: z.string().min(1).describe('工作项编号。'),
      status: z
        .enum([
        ...
        .describe('目标状态，必须符合当前工作项状态机。'),
      assignee_username: z
        .string()
        .optional()
        .describe('新处理人用户名，可留空；留空时保持当前处理人不变。'),
      body: z.string().optional().describe('流转说明，可选。'),
