...
/** @typedef {{ getSystemApiDocs(): Promise<{ source: string }> }} SystemApiDocsClient */
 ...
 * @returns {SystemClient & SystemAuditClient & SystemApiDocsClient}
 */
export function createSystemClient({ request, prepareWrite = async () => {} }) {
  ...
  return {
    ...
    getSystemApiDocs() {
      return request('/api/v1/system/api-docs-view');
    },
