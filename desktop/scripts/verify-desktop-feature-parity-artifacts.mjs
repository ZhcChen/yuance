...
export async function verifyDesktopFeatureParityArtifacts(root) {
  ...
  if (ui?.kind !== "yuance-desktop-feature-parity-ui-smoke" || !ui.sharedApp || !ui.restrictedBridge || !ui.semanticMain || !ui.semanticNavigation || !ui.workItemDetail || !ui.workItemEdited || !ui.workItemHandedOff || !ui.commentCreated || !ui.commentEdited || !ui.workItemAttachmentUploaded || !ui.workItemAttachmentDownloaded || !ui.workItemAttachmentRevealed || !ui.commentAttachmentUploaded || !ui.commentAttachmentDownloaded || !ui.commentAttachmentRevealed || !ui.messageTargetOpened || !ui.messageTargetFocused || !ui.hiddenWindow || ui.lifecycleCycles !== 3 || !ui.networkRecovered || !ui.postResumeRefresh || !ui.keyboardFocus || !Number.isSafeInteger(ui.liveRegions) || ui.liveRegions < 1 || ui.genericBridgeMethods !== 0 || !Number.isSafeInteger(ui.processCount) || ui.processCount < 1 || ui.processCount > 32 || !Number.isSafeInteger(ui.workingSetKb) || ui.workingSetKb < 1 || ui.workingSetKb > 1_048_576 || !Number.isSafeInteger(ui.cpuPercent) || ui.cpuPercent < 0 || ui.cpuPercent > 3_200 || !Number.isSafeInteger(ui.profileBytes) || ui.profileBytes < 1 || ui.profileBytes > 268_435_456) throw new Error("desktop feature parity UI evidence is incomplete");
