...
test("builds non-idempotent mutation descriptors from bounded domain payloads", () => {
  ...
  const cases = [
    ...
    ["system.userprojectsassign", { username: "alice", projectKeys: ["YCE", "OPS"], memberRole: "viewer" }, "POST", "/api/v1/system/users/alice/projects", { project_keys: ["YCE", "OPS"], member_role: "viewer" }],
    ["system.userprojectsremove", { username: "alice", projectKeys: ["OPS"] }, "DELETE", "/api/v1/system/users/alice/projects", { project_keys: ["OPS"] }],
    ["system.userprojectremove", { username: "alice", projectKey: "YCE" }, "DELETE", "/api/v1/system/users/alice/projects/YCE", undefined],
    ["system.userprojectroleupdate", { username: "alice", projectKey: "OPS", memberRole: "maintainer" }, "PATCH", "/api/v1/system/users/alice/projects/OPS/role", { member_role: "maintainer" }],
    ...
    ["project.memberbatchadd", { projectKey: "DEMO", usernames: ["bob", "carol"], memberRole: "viewer" }, "POST", "/api/v1/projects/DEMO/members/batch", { usernames: ["bob", "carol"], member_role: "viewer" }],
    ...
    ["workitem.commentupdate", { itemKey: "DEMO-1", commentId: 9, payload: { body: "<p>Edited</p>", bodyFormat: "html", parentCommentId: null } }, "PATCH", "/api/v1/work-items/DEMO-1/comments/9", { body: "<p>Edited</p>", body_format: "html", parent_comment_id: null }],
  ...
  assert.throws(() => registry.resolve("system.userprojectsassign", { username: "alice", projectKeys: ["invalid"], memberRole: "viewer" }), /projectKey is invalid/);
  assert.throws(() => registry.resolve("system.userprojectroleupdate", { username: "alice", projectKey: "YCE", memberRole: "owner" }), /memberRole is invalid/);
});
...
test("rejects invalid mutation fields before a descriptor is created", () => {
  ...
  for (const [name, input] of [
    ...
    ["workitem.commentcreate", { itemKey: "DEMO-1", payload: { body: "x".repeat(20_001) } }],
    ["workitem.commentcreate", { itemKey: "DEMO-1", payload: { body: "x", bodyFormat: "markdown" } }],
