...
function childArtifacts() {
  return {
    ...
    "desktop-feature-parity-ui-smoke.json": { kind: "yuance-desktop-feature-parity-ui-smoke", sharedApp: true, restrictedBridge: true, semanticMain: true, semanticNavigation: true, workItemDetail: true, workItemEdited: true, workItemHandedOff: true, commentCreated: true, commentEdited: true, workItemAttachmentUploaded: true, workItemAttachmentDownloaded: true, workItemAttachmentRevealed: true, commentAttachmentUploaded: true, commentAttachmentDownloaded: true, commentAttachmentRevealed: true, messageTargetOpened: true, messageTargetFocused: true, permissionDenied: true, permissionInputPreserved: true, validationError: true, validationFocused: true, offlineStateVisible: true, offlineRecoveryVisible: true, interruptionRecovered: true, hiddenWindow: true, lifecycleCycles: 3, networkRecovered: true, postResumeRefresh: true, processCount: 4, workingSetKb: 200_000, cpuPercent: 100, profileBytes: 2_000_000, liveRegions: 1, keyboardFocus: true, genericBridgeMethods: 0 },
