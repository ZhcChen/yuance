...
async fn openapi_json_is_served_for_api_reference() {
    ...
    assert!(body.contains(r#""/api/v1/projects/{project_key}/resources/{resource_id}/attachments""#));
    assert!(body.contains(r#""/api/v1/projects/{project_key}/resources/{resource_id}/attachments/{attachment_id}/uploaded""#));
    assert!(body.contains(r#""/api/v1/projects/{project_key}/resources/{resource_id}/attachments/{attachment_id}/download-url""#));
    assert!(body.contains(r#""operationId": "listProjectResources""#));
